...
function serializePlayerData(toSerialize, options) {
    ...
    if (tutorialStep !== null && toSerialize.triggeredTutorial.find((value) => value === 12) === undefined) {
        userTutorial = {
            "viewer_id": (_a = options === null || options === void 0 ? void 0 : options.viewerId) !== null && _a !== void 0 ? _a : 0,
    ...
    if ((_b = options === null || options === void 0 ? void 0 : options.serializeRushEventData) !== null && _b !== void 0 ? _b : false) {
        // rush event list
...
function deserializePlayerData(playerId, toDeserialize) {
    try {
        ...
        if (characterManaNodeList === undefined)
