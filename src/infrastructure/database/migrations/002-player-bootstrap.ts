...
export const playerBootstrapMigration = {
    version: 2,
    ...
    up(database: BetterSqlite3Database): void {
        database.exec(`
            ...
            CREATE TABLE players_triggered_tutorials (
                id INTEGER NOT NULL,
                player_id INTEGER NOT NULL,
            ...
            CREATE TABLE players_cleared_regular_missions (
                id INTEGER NOT NULL,
                value INTEGER NOT NULL,
                player_id INTEGER NOT NULL,
                PRIMARY KEY (id, player_id),
            ...
            CREATE TABLE daily_challenge_point_list_entries (
                id INTEGER NOT NULL,
            ...
            CREATE TABLE daily_challenge_point_list_campaigns (
                campaign_id INTEGER NOT NULL,
                additional_point INTEGER NOT NULL,
                list_entry_id INTEGER NOT NULL,
                player_id INTEGER NOT NULL,
                PRIMARY KEY (player_id, campaign_id, list_entry_id),
                FOREIGN KEY (list_entry_id, player_id)
                    REFERENCES daily_challenge_point_list_entries(id, player_id)
                    ON DELETE CASCADE,
                FOREIGN KEY (player_id) REFERENCES players(id) ON DELETE CASCADE
            );
            ...
            CREATE TABLE players_characters_bond_tokens (
                ...
                FOREIGN KEY (character_id, player_id)
                    REFERENCES players_characters(id, player_id)
                    ON DELETE CASCADE,
                FOREIGN KEY (player_id) REFERENCES players(id) ON DELETE CASCADE
            );
            ...
            CREATE TABLE players_parties (
                ...
                FOREIGN KEY (group_id, player_id, category)
                    REFERENCES players_party_groups(id, player_id, category)
                    ON DELETE CASCADE,
                FOREIGN KEY (player_id) REFERENCES players(id) ON DELETE CASCADE
            );
            ...
            CREATE TABLE players_gacha_campaigns (
                gacha_id INTEGER NOT NULL,
                campaign_id INTEGER NOT NULL,
            ...
            CREATE TABLE players_drawn_quests (
            ...
            CREATE TABLE players_periodic_reward_points (
                id INTEGER NOT NULL,
                point INTEGER NOT NULL,
                player_id INTEGER NOT NULL,
                PRIMARY KEY (id, player_id),
            ...
            CREATE TABLE players_active_missions_stages (
                ...
                FOREIGN KEY (mission_id, player_id)
                    REFERENCES players_active_missions(id, player_id)
                    ON DELETE CASCADE,
                FOREIGN KEY (player_id) REFERENCES players(id) ON DELETE CASCADE
            );

            CREATE TABLE players_box_gacha (
                id INTEGER NOT NULL,
            ...
            CREATE TABLE players_start_dash_exchange_campaigns (
                campaign_id INTEGER NOT NULL,
                gacha_id INTEGER NOT NULL,
            ...
            CREATE TABLE players_multi_special_exchange_campaigns (
                campaign_id INTEGER NOT NULL,
                status INTEGER NOT NULL,
                player_id INTEGER NOT NULL,
                PRIMARY KEY (campaign_id, player_id),
