export const INFODESK_APP_GROUP_SIG = "0;F8rysQxii/VL6Rca6Gnw/lq1AXA0N1RfAkKHosaiYWM=";
export const INFODESK_APP_SIG = "0;vAbSSdX5LPWU1RzParxOFtK53kTej/zvostVM6USl0w=";

export const INFODESK_APP_GROUP_RESPONSE = {
    status: 200,
    desc: "OK",
    content: {
...
export const INFODESK_APP_RESPONSE = {
    status: 200,
    desc: "OK",
    content: {
        supportedFeatures: ["urgentNotice", "maintenance", "push", "delivery", "promotion", "coupon", "notice"],
        ...
        isWhitelist: false,
        svcStatus: "open",
        supportedIdpCodes: ["facebook", "google", "siwa", "zd3"],
